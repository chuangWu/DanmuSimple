...
import com.yaowang.danmusimple.library.controller.DanmakuFilters.IDanmakuFilter;
import com.yaowang.danmusimple.library.danmaku.model.AlphaValue;
import com.yaowang.danmusimple.library.danmaku.model.BaseDanmaku;
import com.yaowang.danmusimple.library.danmaku.model.GlobalFlagValues;
import com.yaowang.danmusimple.library.danmaku.model.android.AndroidDisplayer;
import com.yaowang.danmusimple.library.danmaku.model.android.BaseCacheStuffer;
import com.yaowang.danmusimple.library.danmaku.model.android.SimpleTextCacheStuffer;
...
public class DanmakuGlobalConfig {
    ...
    public static com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig DEFAULT = new com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig();
     ...
     * @param font
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setTypeface(Typeface font) {
        if (mFont != font) {
            mFont = font;
    ...
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setDanmakuTransparency(float p) {
    ...
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setScaleTextSize(float p) {
        if (scaleTextSize != p) {
            scaleTextSize = p;
            AndroidDisplayer.clearTextHeightCache();
     ...
     * @param visible
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setFTDanmakuVisibility(boolean visible) {
     ...
     * @param visible
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setFBDanmakuVisibility(boolean visible) {
     ...
     * @param visible
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setL2RDanmakuVisibility(boolean visible) {
     ...
     * @param visible
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setR2LDanmakuVisibility(boolean visible) {
     ...
     * @param visible
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setSpecialDanmakuVisibility(boolean visible) {
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setMaximumVisibleSizeInScreen(int maxSize) {
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setDanmakuStyle(int style, float... values) {
        switch (style) {
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setDanmakuBold(boolean bold) {
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setColorValueWhiteList(Integer... colors) {
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setUserHashBlackList(String... hashes) {
    ...
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig removeUserHashBlackList(String... hashes){
        if(hashes == null || hashes.length == 0) {
            return this;
        }
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig addUserHashBlackList(String... hashes){
        if(hashes == null || hashes.length == 0) {
            return this;
        }
        Collections.addAll(mUserHashBlackList, hashes);
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setUserIdBlackList(Integer... ids) {
    ...
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig removeUserIdBlackList(Integer... ids){
        if(ids == null || ids.length == 0) {
            return this;
        }
        for (Integer id : ids) {
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig addUserIdBlackList(Integer... ids){
        if(ids == null || ids.length == 0) {
            return this;
        }
        Collections.addAll(mUserIdBlackList, ids);
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig blockGuestDanmaku(boolean block) {
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setScrollSpeedFactor(float p){
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setDuplicateMergingEnabled(boolean enable) {
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setMaximumLines(Map<Integer, Integer> pairs) {
        if (pairs == null) {
            DanmakuFilters.getDefault()
    ...
    @Deprecated
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setOverlapping(Map<Integer, Boolean> pairs) {
     ...
     * @return
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig preventOverlapping(Map<Integer, Boolean> pairs) {
        if (pairs == null) {
            DanmakuFilters.getDefault()
    ...
    /**
     * 设置缓存绘制填充器，默认使用{@link com.yaowang.danmusimple.library.danmaku.model.android.SimpleTextCacheStuffer}只支持纯文字显示, 如果需要图文混排请设置{@link SpannedCacheStuffer}
     * 如果需要定制其他样式请扩展{@link SimpleTextCacheStuffer}|{@link SpannedCacheStuffer}
     * @param cacheStuffer
     */
    public com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig setCacheStuffer(BaseCacheStuffer cacheStuffer) {
    ...
    public interface ConfigChangedCallback {
        public boolean onDanmakuConfigChanged(com.yaowang.danmusimple.library.danmaku.model.android.DanmakuGlobalConfig config, DanmakuConfigTag tag,
                                              Object... value);
    }
