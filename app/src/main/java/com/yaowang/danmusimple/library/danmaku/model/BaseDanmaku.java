...
public abstract class BaseDanmaku {
    ...
    public boolean isMeasured() {
        return paintWidth >= 0 && paintHeight >= 0
                && measureResetFlag == com.yaowang.danmusimple.library.danmaku.model.GlobalFlagValues.MEASURE_RESET_FLAG;
    }

    public void measure(IDisplayer displayer) {
        displayer.measure(this);
        this.measureResetFlag = com.yaowang.danmusimple.library.danmaku.model.GlobalFlagValues.MEASURE_RESET_FLAG;
    }
    ...
    public boolean isShown() {
        return this.visibility == VISIBLE
                && visibleResetFlag == com.yaowang.danmusimple.library.danmaku.model.GlobalFlagValues.VISIBLE_RESET_FLAG;
    }
    ...
    public boolean hasPassedFilter() {
        if (filterResetFlag != com.yaowang.danmusimple.library.danmaku.model.GlobalFlagValues.FILTER_RESET_FLAG) {
            mFilterParam = 0;
            return false;
        }
        return true;
    ...
    public boolean isFiltered() {
        return filterResetFlag == com.yaowang.danmusimple.library.danmaku.model.GlobalFlagValues.FILTER_RESET_FLAG && mFilterParam != 0;
    }

    public boolean isFilteredBy(int flag) {
        return filterResetFlag == com.yaowang.danmusimple.library.danmaku.model.GlobalFlagValues.FILTER_RESET_FLAG && (mFilterParam & flag) == flag;
    }
