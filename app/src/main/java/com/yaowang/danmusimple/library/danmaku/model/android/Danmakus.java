...
import com.yaowang.danmusimple.library.danmaku.model.Danmaku;
...
public class Danmakus implements IDanmakus {
    ...
    private com.yaowang.danmusimple.library.danmaku.model.android.Danmakus subItems;
    ...
    private Collection<BaseDanmaku> subset(long startTime, long endTime) {
        ...
        if (subItems == null) {
            subItems = new com.yaowang.danmusimple.library.danmaku.model.android.Danmakus(mDuplicateMergingEnabled);
        }
    ...
    public IDanmakus subnew(long startTime, long endTime) {
        ...
        return new com.yaowang.danmusimple.library.danmaku.model.android.Danmakus(newSet);
    }
    ...
    public IDanmakus sub(long startTime, long endTime) {
        ...
        if (subItems == null) {
            if(mSortType == ST_BY_LIST) {
                subItems = new com.yaowang.danmusimple.library.danmaku.model.android.Danmakus(com.yaowang.danmusimple.library.danmaku.model.android.Danmakus.ST_BY_LIST);
    ...
    public void setSubItemsDuplicateMergingEnabled(boolean enable) {
        ...
        if (subItems == null) {
            subItems = new com.yaowang.danmusimple.library.danmaku.model.android.Danmakus(enable);
        }
