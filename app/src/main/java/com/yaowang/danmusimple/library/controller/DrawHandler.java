...
package com.yaowang.danmusimple.library.controller;
...
import com.yaowang.danmusimple.library.controller.CacheManagingDrawTask;
import com.yaowang.danmusimple.library.controller.DrawTask;
import com.yaowang.danmusimple.library.controller.IDanmakuViewController;
import com.yaowang.danmusimple.library.controller.UpdateThread;
import com.yaowang.danmusimple.library.danmaku.model.AbsDisplayer;
...
import com.yaowang.danmusimple.library.danmaku.renderer.IRenderer.RenderingState;
import com.yaowang.danmusimple.library.danmaku.util.AndroidUtils;
import com.yaowang.danmusimple.library.jni.DeviceUtils;
...
public class DrawHandler extends Handler {
    ...
    private com.yaowang.danmusimple.library.controller.IDanmakuViewController mDanmakuView;
    ...
    public DrawHandler(Looper looper, com.yaowang.danmusimple.library.controller.IDanmakuViewController view, boolean danmakuVisibile) {
        super(looper);
...
//                + mCordonTime + ",mFrameRefreshingRate:" + mFrameUpdateRate);
    ...
    public void seekTo(Long ms) {
        ...
        removeMessages(com.yaowang.danmusimple.library.controller.DrawHandler.UPDATE);
        removeMessages(com.yaowang.danmusimple.library.controller.DrawHandler.RESUME);
        removeMessages(com.yaowang.danmusimple.library.controller.DrawHandler.SEEK_POS);
        obtainMessage(com.yaowang.danmusimple.library.controller.DrawHandler.SEEK_POS, ms).sendToTarget();
    }
    ...
    public void resume() {
        sendEmptyMessage(com.yaowang.danmusimple.library.controller.DrawHandler.RESUME);
    }

    public void prepare() {
        sendEmptyMessage(com.yaowang.danmusimple.library.controller.DrawHandler.PREPARE);
    }

    public void pause() {
        syncTimerIfNeeded();
        sendEmptyMessage(com.yaowang.danmusimple.library.controller.DrawHandler.PAUSE);
    }
