...
package com.yaowang.danmusimple.library.danmaku.parser.android;
...
import com.yaowang.danmusimple.library.danmaku.parser.android.AndroidFileSource;
...
public class BiliDanmukuParser extends BaseDanmakuParser {
    ...
    public Danmakus parse() {
        ...
        if (mDataSource != null) {
            com.yaowang.danmusimple.library.danmaku.parser.android.AndroidFileSource source = (AndroidFileSource) mDataSource;
            try {
