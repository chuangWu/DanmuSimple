...
public class AcFunDanmakuParser extends BaseDanmakuParser {
    ...
    public Danmakus parse() {
        if (mDataSource != null && mDataSource instanceof com.yaowang.danmusimple.library.danmaku.parser.android.JSONSource) {
            com.yaowang.danmusimple.library.danmaku.parser.android.JSONSource jsonSource = (JSONSource) mDataSource;
