...
public class BiliDanmakuLoader implements ILoader {
    ...
    private static com.yaowang.danmusimple.library.danmaku.loader.android.BiliDanmakuLoader _instance;
    ...
    public static com.yaowang.danmusimple.library.danmaku.loader.android.BiliDanmakuLoader instance() {
        if (_instance == null) {
            _instance = new com.yaowang.danmusimple.library.danmaku.loader.android.BiliDanmakuLoader();
        }
        return _instance;
    }
